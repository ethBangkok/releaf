  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      <header className="text-center mb-8">
        ...
        <p className="text-2xl font-semibold text-primary">Total Pool Balance: ${totalBalance.toLocaleString()}</p>
      </header>
          ...
          <CardContent>
            <form className="space-y-4">
              <div className="space-y-2">
                ...
                />
                {error && <p id="amount-error" className="text-sm text-red-500">{error}</p>}
              </div>
              <div className="space-y-2">
              ...
              <Button className="w-full" onClick={handleFundNow}>Fund Now</Button>
            </form>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                ${currentFunding.toLocaleString()} out of ${totalBalance.toLocaleString()}
              </p>
            </div>
            <div>
